...
% Recommended for theses, not for smaller papers (but you do you)
...
% If the option 'titlepage' is enabled in \documentclass, then this title will automatically get its own page
\maketitle
